...
# === Configuration ===
SCRIPT_PATH="/srv/jimflix/jimflix-scripts/scripts/cleanup-riven-1080p-db.sh"
CONTAINER_NAME="riven-1080p-db"
poll_interval=10
LOCKFILE="/tmp/cleanup-riven-1080p-db.lock"
WATCH_DIR="/srv/jimflix/plex/media/rd-media-1080p"
...
log "Poller started for cleanup-riven-1080p-db.sh"
