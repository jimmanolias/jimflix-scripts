...
LOCKFILE="/tmp/cleanup-riven-1080p-db.lock"
LOGFILE="/srv/jimflix/jimflix-scripts/logs/cleanup-riven-1080p-db.log"
CONTAINER_NAME="riven-1080p-db"
MOUNTPOINT="/mnt/zurg"
...
log ""
log "INFO" "Starting cleanup script (cleanup-riven-1080p-db.sh)"

if ! /srv/jimflix/jimflix-scripts/scripts/check-rd.sh; then
    log "WARN" "Real-Debrid subscription inactive — skipping cleanup-riven-1080p-db.sh"
    exit 0
fi
...
##########################
log "INFO" "Scanning Riven-1080p-DB for Movies missing media files"
deleted_movies=0
...
##########################
log "INFO" "Scanning Riven-1080p-DB for Episodes missing media files"
deleted_episodes=0
...
##########################
log "INFO" "Scanning Riven-1080p-DB for Seasons without any Episodes"
deleted_seasons=0
...
##########################
log "INFO" "Scanning Riven-1080p-DB for Shows without any Seasons"
deleted_shows=0
